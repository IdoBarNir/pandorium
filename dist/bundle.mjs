...
/***/ "./setups/packageJson/index.ts":
/*!*************************************!*\
  !*** ./setups/packageJson/index.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   packageJsonSetup: () => (/* binding */ packageJsonSetup)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @utils */ \"./utils/index.ts\");\n/* harmony import */ var _packageJsonSetup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./packageJsonSetup */ \"./setups/packageJson/packageJsonSetup.ts\");\n\n\nconst packageJsonSetup = async () => await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.loggerDogger)({\n    child: _packageJsonSetup__WEBPACK_IMPORTED_MODULE_1__.packageJsonSetup,\n    childLabel: \"package.json Setup\",\n    onlyTryCatch: true,\n});\n\n\n//# sourceURL=webpack://pandorium/./setups/packageJson/index.ts?");

/***/ }),

/***/ "./setups/packageJson/packageJsonSetup.ts":
/*!************************************************!*\
  !*** ./setups/packageJson/packageJsonSetup.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   packageJsonSetup: () => (/* binding */ packageJsonSetup)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @utils */ \"./utils/index.ts\");\n\nconst packageJsonSetup = async () => {\n    const updatedPackageJson = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.readFileAsync)({\n        fileName: \"package\",\n        fileType: \"json\",\n    });\n    updatedPackageJson.license = \"MIT\";\n    await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.writeFileAsync)({\n        fileName: \"package\",\n        fileType: \"json\",\n        fileContent: updatedPackageJson,\n    });\n};\n\n\n//# sourceURL=webpack://pandorium/./setups/packageJson/packageJsonSetup.ts?");
...
/***/ "./setups/tsconfig/index.ts":
/*!**********************************!*\
  !*** ./setups/tsconfig/index.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   tsconfigSetup: () => (/* binding */ tsconfigSetup)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @utils */ \"./utils/index.ts\");\n/* harmony import */ var _tsconfigSetup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tsconfigSetup */ \"./setups/tsconfig/tsconfigSetup.ts\");\n\n\nconst tsconfigSetup = async () => await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.loggerDogger)({\n    child: _tsconfigSetup__WEBPACK_IMPORTED_MODULE_1__.tsconfigSetup,\n    childLabel: \"tsconfig.json Setup\",\n    onlyTryCatch: true,\n});\n\n\n//# sourceURL=webpack://pandorium/./setups/tsconfig/index.ts?");

/***/ }),

/***/ "./setups/tsconfig/tsconfigSetup.ts":
/*!******************************************!*\
  !*** ./setups/tsconfig/tsconfigSetup.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   tsconfigSetup: () => (/* binding */ tsconfigSetup)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @utils */ \"./utils/index.ts\");\n\nconst tsconfigSetup = async () => {\n    const updatedTsconfig = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.readFileAsync)({\n        fileName: \"tsconfig\",\n        fileType: \"json\",\n    });\n    updatedTsconfig.compilerOptions = updatedTsconfig.compilerOptions || {};\n    await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.writeFileAsync)({\n        fileName: \"tsconfig\",\n        fileType: \"json\",\n        fileContent: updatedTsconfig,\n    });\n};\n\n\n//# sourceURL=webpack://pandorium/./setups/tsconfig/tsconfigSetup.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   checkDirectoryExists: () => (/* reexport safe */ _checkDirectoryExists__WEBPACK_IMPORTED_MODULE_4__.checkDirectoryExists),\n/* harmony export */   createDirectory: () => (/* binding */ createDirectory),\n/* harmony export */   readFileAsync: () => (/* binding */ readFileAsync),\n/* harmony export */   writeFileAsync: () => (/* binding */ writeFileAsync)\n/* harmony export */ });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @utils */ \"./utils/index.ts\");\n/* harmony import */ var _createDirectory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createDirectory */ \"./utils/file/createDirectory.ts\");\n/* harmony import */ var _readFileAsync__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./readFileAsync */ \"./utils/file/readFileAsync.ts\");\n/* harmony import */ var _writeFileAsync__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./writeFileAsync */ \"./utils/file/writeFileAsync.ts\");\n/* harmony import */ var _checkDirectoryExists__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./checkDirectoryExists */ \"./utils/file/checkDirectoryExists.ts\");\n\n\n\n\nconst createDirectory = async ({ directoryPath }) => await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.loggerDogger)({\n    child: _createDirectory__WEBPACK_IMPORTED_MODULE_1__.createDirectory,\n    childLabel: \"Directory Creation\",\n    args: { directoryPath },\n    onlyTryCatch: true,\n});\nconst readFileAsync = async ({ fileName, fileType }) => await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.loggerDogger)({\n    child: _readFileAsync__WEBPACK_IMPORTED_MODULE_2__.readFileAsync,\n    childLabel: \"Reading File Async\",\n    args: { fileName, fileType },\n    onlyTryCatch: true,\n});\nconst writeFileAsync = async ({ fileName, fileType, fileContent }) => await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.loggerDogger)({\n    child: _writeFileAsync__WEBPACK_IMPORTED_MODULE_3__.writeFileAsync,\n    childLabel: \"Writing File Async\",\n    args: { fileName, fileType, fileContent },\n    onlyTryCatch: true,\n});\n\n\n\n//# sourceURL=webpack://pandorium/./utils/file/index.ts?");

/***/ }),

/***/ "./utils/file/readFileAsync.ts":
/*!*************************************!*\
  !*** ./utils/file/readFileAsync.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   readFileAsync: () => (/* binding */ readFileAsync)\n/* harmony export */ });\n/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fs/promises */ \"fs/promises\");\n/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fs_promises__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! path */ \"path\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @config */ \"./config/index.ts\");\n/* harmony import */ var _checkDirectoryExists__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkDirectoryExists */ \"./utils/file/checkDirectoryExists.ts\");\n\n\n\n\nconst readFileAsync = async ({ fileName, fileType }) => {\n    if (await (0,_checkDirectoryExists__WEBPACK_IMPORTED_MODULE_3__.checkDirectoryExists)({ directoryPath: _config__WEBPACK_IMPORTED_MODULE_2__.PROJECT_PATH })) {\n        const resolvedPath = path__WEBPACK_IMPORTED_MODULE_1___default().resolve(process.cwd(), _config__WEBPACK_IMPORTED_MODULE_2__.PROJECT_PATH, `${fileName}.${fileType}`);\n        const fileContent = await (0,fs_promises__WEBPACK_IMPORTED_MODULE_0__.readFile)(resolvedPath, \"utf8\");\n        if (fileType === \"json\") {\n            const jsonContent = JSON.parse(fileContent);\n            return jsonContent;\n        }\n        return fileContent;\n    }\n};\n\n\n//# sourceURL=webpack://pandorium/./utils/file/readFileAsync.ts?");

/***/ }),

/***/ "./utils/file/writeFileAsync.ts":
/*!**************************************!*\
  !*** ./utils/file/writeFileAsync.ts ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   writeFileAsync: () => (/* binding */ writeFileAsync)\n/* harmony export */ });\n/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fs/promises */ \"fs/promises\");\n/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fs_promises__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! path */ \"path\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @config */ \"./config/index.ts\");\n/* harmony import */ var _checkDirectoryExists__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkDirectoryExists */ \"./utils/file/checkDirectoryExists.ts\");\n\n\n\n\nconst writeFileAsync = async ({ fileName, fileType, fileContent }) => {\n    if (await (0,_checkDirectoryExists__WEBPACK_IMPORTED_MODULE_3__.checkDirectoryExists)({ directoryPath: _config__WEBPACK_IMPORTED_MODULE_2__.PROJECT_PATH })) {\n        const resolvedPath = path__WEBPACK_IMPORTED_MODULE_1___default().resolve(process.cwd(), _config__WEBPACK_IMPORTED_MODULE_2__.PROJECT_PATH, `${fileName}.${fileType}`);\n        if (fileType === \"json\") {\n            await (0,fs_promises__WEBPACK_IMPORTED_MODULE_0__.writeFile)(resolvedPath, JSON.stringify(fileContent, null, 2));\n        }\n        else {\n            await (0,fs_promises__WEBPACK_IMPORTED_MODULE_0__.writeFile)(resolvedPath, fileContent);\n        }\n    }\n};\n\n\n//# sourceURL=webpack://pandorium/./utils/file/writeFileAsync.ts?");
